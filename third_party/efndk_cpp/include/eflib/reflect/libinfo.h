...
#ifndef __REFLECT_LibInfo_H__
#define __REFLECT_LibInfo_H__

#include "reflect.h"

#define CLS_reflect_LibInfo  LIB_REFLECT myT(".") myT("类库信息")
#define IDX_reflect_LibInfo  (IDX_sys_Object + 1)

#define ENUM_reflect_Language  LIB_REFLECT myT(".") myT("类库语言")

#endif //__REFLECT_LibInfo_H__
