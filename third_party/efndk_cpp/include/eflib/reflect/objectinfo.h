...
#ifndef __REFLECT_ObjectInfo_H__
#define __REFLECT_ObjectInfo_H__


#include "reflect.h"

#define CLS_reflect_ObjectInfo  LIB_REFLECT myT(".") myT("对象信息")
#define IDX_reflect_ObjectInfo  (IDX_sys_Object + 1)


#endif //__REFLECT_ObjectInfo_H__
