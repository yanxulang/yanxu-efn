...
#ifndef __EF_SYS_OTHERS_H__
#define __EF_SYS_OTHERS_H__

#include <ef/ef.h>

#define I_sys_Runable  myT("系统.可执行")


inline void sys_Runable_Run(EFInterface* pInterface)
{
	EF_IM_0(pInterface, 0, void);
}


#endif //__EF_SYS_OTHERS_H__
